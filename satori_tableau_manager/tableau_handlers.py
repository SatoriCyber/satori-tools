...
def get_all_tableau_datasources(headers, event_data):
	...
	while not(tableau_datasource_done):
		...
		tableau_datasource_page = get_content(url, headers)
...
def get_all_tableau_workbooks(headers, event_data):
	...
	while not(tableau_workbooks_done):
		...
		tableau_workbooks_page = get_content(url, headers)
...
def update_one_connection(url, headers, newhostname, newusername, newpassword):
